...
@section('menu')
    ...
    <li class="colorlib-active"><a href="{{ '/style' }}">Dự án - Công trình</a></li>
					   			...
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc desc2">
					   						<p class="tag"><span>Phong thủy</span></p>
						   					<h1><a href="#">Yếu tố quan trọng nhất của ngôi nhà tốt</a></h1>
						   					<p>Nhiều khách hàng lựa chọn chúng tôi để đưa phong thủy vào ngôi nhà thân yêu của họ, nhằm mang đến sự hưng thịnh nhất cho gia chủ</p>
